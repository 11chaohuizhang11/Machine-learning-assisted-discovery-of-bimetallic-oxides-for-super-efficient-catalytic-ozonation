...
tree = DecisionTreeRegressor(max_depth=4, random_state=42, max_features=3)
tree = tree.fit(x_train,y_train)
model = AdaBoostRegressor(n_estimators=49, learning_rate=0.6963, random_state=42)
...
plt.savefig('D:/133/ML/LOAD/ADA/importanceADA5.tif', dpi=300)
plt.show()
...
plt.legend()
plt.savefig('D:/133/ML/LOAD/ADA/ADA.tif', dpi=300)
y_test=pd.DataFrame(data=y_test)
pre_test=pd.DataFrame(data=pre_test)
pre_train=pd.DataFrame(data=pre_train)
y_test.to_excel('D:/133/ML/LOAD/ADA/ADA5_test.xlsx')
pre_test.to_excel('D:/133/ML/LOAD/ADA/ADA5_pred.xlsx')
y_train.to_excel('D:/133/ML/LOAD/ADA/ADA5_train.xlsx')
pre_train.to_excel('D:/133/ML/LOAD/ADA/ADA5_pretrain.xlsx')