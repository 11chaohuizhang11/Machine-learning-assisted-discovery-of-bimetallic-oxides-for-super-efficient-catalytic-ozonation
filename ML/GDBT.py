...
model = GradientBoostingRegressor(n_estimators=80, max_features=6, max_depth=4, max_leaf_nodes=5, random_state=42)
...
plt.savefig('D:/133/ML/LOAD/GDBT/importancegbdt9.tif',dpi=300)
plt.show()
...
plt.legend()
plt.savefig('D:/133/ML/LOAD/GDBT/gbdt17.tif',dpi=300)
y_test=pd.DataFrame(data=y_test)
pre_test=pd.DataFrame(data=pre_test)
pre_train=pd.DataFrame(data=pre_train)
y_test.to_excel('D:/133/ML/LOAD/GDBT/GDBT8_test.xlsx')
pre_test.to_excel('D:/133/ML/LOAD/GDBT/GDBT8_pred.xlsx')
y_train.to_excel('D:/133/ML/LOAD/GDBT/GDBT8_train.xlsx')
pre_train.to_excel('D:/133/ML/LOAD/GDBT/GDBT8_pretrain.xlsx')
print(pre_test)